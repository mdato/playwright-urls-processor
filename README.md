...
About this Project:
-------------------
* 🌍  Project based in Express, Playwright
* 🖥️  This app allows you to enter a list of URLs, which will be opened in the browser, and provides a final summary detailing whether there were any errors loading them. You can also test it by including fictitious URLs.
